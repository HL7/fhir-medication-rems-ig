...
* rest.mode = #server
* rest.documentation = "When participating in exchanges described in the Medication REMS FHIR IG, the Provider System **SHALL** 1. Implement RESTful behavior according to the FHIR specification. 1. Support the JSON source format. \nWhen participating in exchanges described in the Medication REMS FHIR IG, the Provider System **SHOULD**: 1. Support the XML source format."
* rest.security.description = "1. Communication security implemented by the Provider System SHALL conform with the guidelines stated in [FHIR Security](https://www.hl7.org/fhir/security.html) for all exchanges covered in this IG. 1. For general security considerations refer to [FHIR Security and Privacy Considerations](https://www.hl7.org/fhir/secpriv-module.html)."