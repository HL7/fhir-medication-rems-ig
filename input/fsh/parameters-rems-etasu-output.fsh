...
* parameter.resource.subject.reference = "Patient/pat017"
...
* parameter.resource.contained.parameter[=].resource.status = #success
* parameter.resource.contained.parameter[=].resource.moduleUri = "https://build.fhir.org/ig/HL7/fhir-medication-rems-ig/"
* parameter.resource.contained.parameter[=].resource.subject.reference = "Practitioner/pra1234"
* parameter.resource.contained.parameter[=].resource.note.text = "Prescriber Enrollment"
* parameter.resource.contained.parameter[+].name = "Pharmacist Enrollment"
* parameter.resource.contained.parameter[=].resource.resourceType = "GuidanceResponse"
* parameter.resource.contained.parameter[=].resource.status = #success
* parameter.resource.contained.parameter[=].resource.moduleUri = "https://build.fhir.org/ig/HL7/fhir-medication-rems-ig/"
* parameter.resource.contained.parameter[=].resource.subject.reference = "Organization/pharm0111"
* parameter.resource.contained.parameter[=].resource.note.text = "Pharmacist Enrollment"
* parameter.resource.contained.parameter[+].name = "auth_number"
